...
<template>
    <div class="flex flex-col md:flex-row h-[100%] gap-4 md:gap-8 pt-[90px] md:pt-[5%]">
        <div class="flex flex-col justify-center w-full md:w-1/2 font-['Manrope'] order-1 md:order-1 pt">
            <div class="flex flex-col justify-start gap-2 w-full">
                <h1 class="text-[2rem] md:text-[2.5rem] text-white font-semibold m-0">Marc Marqués</h1>
                <p class="text-xl md:text-2xl text-[#ccc] m-0 font-extralight"><span class="text-[#fbf060]">Full-stack
                        web developer</span> from Barcelona, Spain.</p>
                ...
                <div class="flex gap-4 mt-3">
                    ...
                    <a href="https://linkedin.com/in/marc-marques-fernandez" target="_blank" rel="noopener noreferrer"
                       class="inline-flex items-center justify-center px-4 py-2 bg-transparent text-gray-200 rounded-md border border-gray-400 hover:bg-gray-500/30 transition-colors duration-200 cursor-pointer"
                       @mouseenter="handleCursorHover"
                       @mouseleave="handleCursorLeave">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
